...
public class QuestionFeignController implements QuestionFeignClient {
    ...
    public QuestionSubmission getQuestionSubmitById(@RequestParam("questionSubmitId") Long questionSubmitId) {
    ...
    public BaseResponse<Boolean> updateQuestionSubmitById(@RequestBody QuestionSubmission questionSubmission) {
        return ResultUtils.success(questionSubmitService.updateById(questionSubmission));
    }
}
